...
if __name__ == "__main__":
    ...
    model_name = 'Color2Manga_74000'
    ckpt_path = 'experiments/Color2Manga_ori/074000.pt'
    test_dir_path = 'test_datasets/gray2color/manga_test/'
    ...
    out_img_path = os.path.join(out_dir_path, img_name ,'_out.png')
